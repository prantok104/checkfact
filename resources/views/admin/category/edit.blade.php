        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit ( {{ $category->name_en }} ) | <a href="{{ route('admin.category.add-new') }}" class="text-primary">Add New Category</a></h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Edit category</code>.
                        </p>
                    </div><!--end card-header-->
                    <div class="card-body">
                            ...
                            <div class="col-lg-3">
                                <form action="{{ route('admin.category.update', ['id' => $category->id]) }}" method="POST">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('category_name_en') is-invalid @enderror" type="text" name="category_name_en" value="{{ $category->name_en }}" placeholder="Category name" id="example-text-input">
                                            <br>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control  @error('category_name_bn') is-invalid @enderror" type="text" name="category_name_bn" value="{{ $category->name_bn }}" placeholder="ক্যাটাগরি নাম" id="example-text-input1">
                                            <br>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="description" cols="30" rows="3" id="example-text-input-lg" class="form-control">{{ $category->description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control  @error('category_icon') is-invalid @enderror" name="category_icon" value="{{ $category->icon }}" type="text" placeholder="<i class='fa fa-user'></i>" id="example-text-input-sm">
                                            <br>
                                            @error('category_icon')
                                            <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}</div>
                                            @enderror
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <button class="btn btn-primary">Category Update</button>
                                        </div>
                                    </div>
                                </form>
