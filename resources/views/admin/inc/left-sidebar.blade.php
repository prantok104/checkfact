...
<div class="left-sidebar">
    ...
    <div class="border-end">
        <ul class="nav nav-tabs menu-tab nav-justified" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#Extra" role="tab" aria-selected="false">W<span>ebsite</span></a>
            </li>
        </ul>
    </div>
    <!-- Tab panes -->
        ...
        <div class="menu-body navbar-vertical">
            <div class="collapse navbar-collapse tab-content" id="sidebarCollapse">
                ...
                <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                    <li class="menu-label mt-0 text-primary font-12 fw-semibold">M<span>ain</span><br><span class="font-10 text-secondary fw-normal">Dashboard Menu</span></li>
                    <li class="nav-item">
                        ...
                        <div class="collapse " id="sidebarAnalytics">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.block.users') }}" class="nav-link ">Blocked Users</a>
                                </li><!--end nav-item-->
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse " id="posts">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link d-flex justify-content-between align-items-center" href="{{ route('admin.posts.add-new') }}">Add New <i class="ti ti-plus mr-2"></i></a>
                                </li><!--end nav-item-->
                                <li class="nav-item">
                                    <a class="nav-link d-flex justify-content-between align-items-center" href="{{ route('admin.posts.all') }}">View All <i class="ti ti-eye-check mr-2"></i></a>
                                </li><!--end nav-item-->
                                <li class="nav-item">
                                    <a class="nav-link d-flex justify-content-between align-items-center" href="{{ route('admin.posts.draft.all') }}">Draft <i class="ti ti-eye-check mr-2"></i></a>
                                </li><!--end nav-item-->
                                <li class="nav-item">
                                    <a class="nav-link d-flex justify-content-between align-items-center" href="{{ route('admin.posts.trash') }}">Trashed <i class="ti ti-trash mr-2"></i></a>
                                </li><!--end nav-item-->
                            </ul><!--end nav-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#videos" data-bs-toggle="collapse" role="button"
                        ...
                        <div class="collapse " id="videos">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link d-flex justify-content-between align-items-center" href="{{ route('admin.video.add-new') }}">Add New <i class="ti ti-plus mr-2"></i></a>
                                </li><!--end nav-item-->
                                <li class="nav-item">
                                    <a class="nav-link d-flex justify-content-between align-items-center" href="{{ route('admin.video.trash') }}">Trashed <i class="ti ti-trash mr-2"></i></a>
                                </li><!--end nav-item-->
                            </ul><!--end nav-->
                        </div><!--end sidebarCrypto-->
                    </li><!--end nav-item-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#subscriber" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="subscriber">
                ...
                <ul class="navbar-nav tab-pane" id="Extra" role="tabpanel">
                    <li>
                        <div class="update-msg text-center position-relative">
                            ...
                            <h5 class="mt-0">Check Fact</h5>
                            <p class="mb-3"></p>
                            <a href="{{ route('front.homepage') }}" target="_blank" class="btn btn-outline-warning btn-sm">Visit Now</a>
                        </div>
                    </li>
                </ul><!--end navbar-nav--->
