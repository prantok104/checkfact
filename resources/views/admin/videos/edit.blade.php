        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit ( {{ $video->title_en }} ) | <a href="{{ route('admin.video.add-new') }}" class="text-primary">Add New Video</a></h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Edit video</code>.
                        </p>
                    </div><!--end card-header-->
                    <div class="card-body">
                            ...
                            <div class="col-lg-3">
                                <form action="{{ route('admin.video.update', ['id' => $video->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('ytLink') is-invalid @enderror" type="text" name="ytLink" value="{{ $video->video_link }}" id="example-text-input">
                                            <br>
                                            @error('ytLink')
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('title_en') is-invalid @enderror" type="text" name="title_en" value="{{ $video->title_en }}" id="example-text-input">
                                            <br>
                                            @error('title_en')
                                            <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}</div>
                                            @enderror
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control  @error('title_bn') is-invalid @enderror" type="text" name="title_bn" value="{{ $video->title_bn }}" id="example-text-input1">
                                            <br>
                                            @error('title_bn')
                                            <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}</div>
                                            @enderror
                                    ...
                                    <div class="input-group mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img src="{{$video->getFirstMediaUrl('video')}}" alt="" width="170px">
                                            <br>
                                            @error('video_thumb')
                                            <div class="invalid-feedback"><i class="fa fa-exclamation-triangle"></i> {{$message}}</div>
                                            @enderror
